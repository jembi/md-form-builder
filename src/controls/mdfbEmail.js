...
.directive('mdfbEmail', function($compile) {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'scripts/directives/mdFormBuilder/controls/mdfbEmail.html',
    scope: {
      field: '=',
      form: '=',
      globals: '='
    ...
    link: function (scope, elem, attrs) {
      ...
      if ( scope.field.skipLogic ){
        initSkipLogicEmail( scope, elem, attrs, scope.field );
      }
...
var initSkipLogicEmail = function(scope, elem, attrs, formField){
