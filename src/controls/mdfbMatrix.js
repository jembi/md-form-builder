...
.directive('mdfbMatrix', function($compile) {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'scripts/directives/mdFormBuilder/controls/mdfbMatrix.html',
    scope: {
      field: '=',
      form: '=',
      globals: '='
    ...
    link: function (scope, elem, attrs) {
      ...
      if ( scope.field.skipLogic ){
        initSkipLogicMatrix( scope, elem, attrs, scope.field );
      }
...
var initSkipLogicMatrix = function(scope, elem, attrs, formField){
