...
.directive('mdfbInput', function($compile) {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'scripts/directives/mdFormBuilder/controls/mdfbInput.html',
    scope: {
      field: '=',
      form: '=',
      globals: '='
    ...
    link: function (scope, elem, attrs) {
      ...
      if ( scope.field.skipLogic ){
        initSkipLogicInput( scope, elem, attrs, scope.field );
      }
...
var initSkipLogicInput = function(scope, elem, attrs, formField){
