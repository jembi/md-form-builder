...
.directive('mdfbSelect', function($compile) {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'scripts/directives/mdFormBuilder/controls/mdfbSelect.html',
    scope: {
      field: '=',
      form: '=',
      globals: '='
...
var initSkipLogicSelect = function(scope, elem, attrs, formField){
